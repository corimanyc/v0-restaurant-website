    ...
    >
      ...
      <div className="flex items-center justify-between" style={{ padding: '24px' }}>
        ...
        <button
          ...
          style={{ fontFamily: 'Switzer, sans-serif', fontSize: '28px', fontWeight: 400, letterSpacing: '-0.01em', lineHeight: 1, background: 'transparent', border: 'none', padding: '0 0 4px 0', cursor: 'pointer' }}
