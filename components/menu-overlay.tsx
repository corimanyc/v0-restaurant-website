...
export default function MenuOverlay({ isOpen, onClose, scrollToSection }: MenuOverlayProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-[#515151] flex flex-col"
      style={{
        zIndex: 60,
    ...
    >
      ...
      <div className="flex overflow-hidden justify-between" style={{ flex: '1 1 0', minHeight: 0 }}>
        ...
        <div
          ref={scrollRef}
          className="overflow-y-auto w-full lg:w-1/2 pr-9 lg:pr-0"
          style={{
        ...
        >
            ...
            <div className="flex flex-col">
              {alaCarteItems.map((item, i) => (
                <div key={i} className="flex items-start justify-between py-4">
                  <p className="text-black uppercase flex-1 min-w-0" style={{ ...base, maxWidth: '480px' }}>
                    {item.name}
                  </p>
                  <p className="text-black flex-shrink-0 text-right" style={{ ...base, marginLeft: '32px' }}>
                    {item.price || '—'}
                  </p>
                </div>
              ))}
          ...
          <div ref={wineRef} data-section="wine" style={{ marginTop: '56px' }}>
            ...
            <p className="text-black mb-10" style={{ ...base, fontSize: '14px', maxWidth: '500px' }}>
